...
Inspected the structure, data types, and missing values.
Cleaned the dataset by converting numeric fields, removing duplicates, filling missing values, and extracting a year feature.
Performed exploratory data analysis with visualizations for spending distribution, spending by generic name, claims vs. spending, and spending over time.
